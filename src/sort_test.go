	...
	cases := []testCase{
		{
			...
			args: "-f .* -r %03d -e -sort size -E exiftool " + testDir,
		},
		{
			...
			args: "-f .* -r %03d -e -sortr size -E exiftool " + testDir,
		},
	}
	...
	cases := []testCase{
		{
			...
			args: "-f .* -r %03d -e -sort default -E exiftool " + testDir,
		},
		{
			name: "Sort files alphabetically in a descending order",
			want: []Change{
			...
			args: "-f .* -r %03d -e -sortr default -E exiftool " + testDir,
		},
	}
